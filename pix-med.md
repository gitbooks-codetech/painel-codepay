...
Para lançar os MEDs, clique no item de menu Administração e selecione Pix MED.

<figure><img src=".gitbook/assets/image (31).png" alt="" width="148"><figcaption></figcaption></figure>

### Filtrando a lista de MED

A página de MED pode ser filtrada por cliente, paymentId, e2e, externalId e o tipo do MED (se Pix MED ou Estorno)
